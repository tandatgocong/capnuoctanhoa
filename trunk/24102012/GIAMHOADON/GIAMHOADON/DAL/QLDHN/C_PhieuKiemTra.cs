...
namespace GIAMHOADON.DAL.QLDHN
{
    class C_PhieuKiemTra
    {
        ...
        public static DataSet getListHoaDonReport(string danhba, int nam, int ky, int dot)
        {
            ...
            //query2 += " FROM DocSo_PHT.dbo.DS" + nam + " AS ds, GIAMHOADON.dbo.TB_DULIEUKHACHHANG as kh,DocSo_PHT.dbo.NHANVIEN nv ";
            ...
            //query = "select * FROM GIAMHOADON.dbo.TB_DHN_BAOCAO";
            //adapter = new SqlDataAdapter(query, db.Connection.ConnectionString);
