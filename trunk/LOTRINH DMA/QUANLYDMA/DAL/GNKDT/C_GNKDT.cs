...
namespace CAPNUOCTANHOA.DAL.GNKDT
{
    class C_GNKDT
    {
        ...
        public static DataTable getThongTinDMAByHoaDon(string madma, string ky, string nam)
        {
            ...
            string query = "  SELECT tb1.*, tb2.CHUKY, tb2.CODE,tb2.LNCC,(convert(float,tb2.LNCC)/tb2.CHUKY) as 'TBTT' ";
        ...
        public static DataTable getThongTinDMAByHandheld(string madma, string ky, string nam)
        {
            ...
            string query = "    SELECT tb1.*, tb2.CODE,tb2.TIEUTHU as 'LNCC',(convert(float,tb2.TIEUTHU)/tb1.CHUKYDS) as 'TBTT' ";
