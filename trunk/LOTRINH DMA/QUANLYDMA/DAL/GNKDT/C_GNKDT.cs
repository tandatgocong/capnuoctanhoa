...
namespace CAPNUOCTANHOA.DAL.GNKDT
{
    class C_GNKDT
    {
        ...
        public static DataTable getThongTinDMAByHandheld(string madma, string ky, string nam)
        {
            ...
            string query = " SELECT DISTINCT LOTRINH,DANHBO,HOPDONG,HOTEN,SONHA,TENDUONG,CODH,GIABIEU,DINHMUC, HIEULUC ,CHUKYDS as 'CHUKY',NAMLD, tb2.CODE,tb2.TIEUTHU as 'LNCC',(convert(float,tb2.TIEUTHU)/tb1.CHUKYDS) as 'TBTT'    ";
