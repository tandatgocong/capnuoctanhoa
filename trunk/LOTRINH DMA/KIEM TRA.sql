...
WHERE   DANHBO  IN (SELECT DANHBO FROM DMA_TEST  WHERE MADMA = 'TH-07-01' ) AND MADMA IS NOT NULL
...
UPDATE TB_DULIEUKHACHHANG SET MADMA='TH-07-01' WHERE MADMA IS NULL AND DANHBO IN (SELECT DANHBO FROM DMA_TEST WHERE MADMA='TH-07-01')
