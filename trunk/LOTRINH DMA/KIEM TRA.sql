SELECT DANHBO,HOTEN,SONHA,TENDUONG,MADMA ,KY, NAM FROM TB_DULIEUKHACHHANG WHERE MADMA='TH-12-05'
...
-------------------
UPDATE TB_DULIEUKHACHHANG SET MADMA='TH-12-05' WHERE DANHBO IN (SELECT DANHBO FROM DMA_TEST) AND MADMA IS NULL

 
UPDATE TB_DULIEUKHACHHANG SET MADMA='TH-06-03' WHERE  DANHBO   IN (SELECT DANHBO FROM DMA_TEST WHERE MADMA='TH-06-02')

UPDATE TB_DULIEUKHACHHANG SET MADMA= NULL WHERE MADMA='TH-12-05' AND KY_<=1 AND NAM<=2014
...
SELECT * FROM DMA_TEST WHERE MADMA='TH-12-05' AND DANHBO NOT IN (SELECT DANHBO FROM TB_DULIEUKHACHHANG WHERE MADMA='TH-08-02')
