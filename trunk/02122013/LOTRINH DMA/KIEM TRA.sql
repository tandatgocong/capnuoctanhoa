SELECT DANHBO FROM TB_DULIEUKHACHHANG WHERE MADMA='TH-09-02' AND KY_<=6 AND NAM<=2013
...
-------------------
UPDATE TB_DULIEUKHACHHANG SET MADMA='TH-09-05' WHERE DANHBO IN (SELECT DANHBO FROM DMA_TEST) AND MADMA IS NULL
