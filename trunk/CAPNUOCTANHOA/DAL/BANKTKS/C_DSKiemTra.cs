...
namespace CAPNUOCTANHOA.DAL.BANKTKS
{
    class C_DSKiemTra
    {
        ...
        {
            string sql = "SELECT TOP(1) ds.KY,ds.DOT,YEAR(ds.NGAYGHI) AS 'NAM', ds.TODS, DANHBO, ds.MALOTRINH,HOTEN,(SONHA+' '+TENDUONG) AS DIACHI,kh.HOPDONG,ds.GB ,ds.DM, ds.CSMOI,kh.HIEUDH,kh.CODH,kh.SOTHANDH";
