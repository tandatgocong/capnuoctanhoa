...
namespace CAPNUOCTANHOA.DAL.QLDHN
{
    class C_HoaDon_0
    {
        ...
        public static DataTable getBangKeBaoThay(int sobangke)
        {
            ...
            sql += " FROM DK_GIAMHOADON GHD,TB_DULIEUKHACHHANG kh WHERE  kh.DANHBO=GHD.DHN_DANHBO AND DHN_SOBANGKE='" + sobangke + "' ORDER BY DHN_NGAYGHINHAN ASC";
        ...
        public static DataTable getDanhBo (string danhbo)
        {
            ...
            sql += " FROM DK_GIAMHOADON GHD,TB_DULIEUKHACHHANG kh WHERE  kh.DANHBO=GHD.DHN_DANHBO AND DHN_DANHBO='" + danhbo + "' ORDER BY DHN_NGAYGHINHAN ASC";
            return LinQConnection.getDataTable(sql);
