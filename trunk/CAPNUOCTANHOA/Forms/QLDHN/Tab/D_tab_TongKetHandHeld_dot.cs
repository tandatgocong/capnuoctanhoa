...
namespace CAPNUOCTANHOA.Forms.QLDHN.Tab
{
    public partial class tabtab_TongKetHandHeld_dot : UserControl
    {
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            rp.SetParameterValue("tenbk", "THỐNG KÊ SẢN LƯỢNG ĐỢT " + cbDotDS.Items[cbDotDS.SelectedIndex].ToString() + " KỲ  " + cbKyDS.Items[cbKyDS.SelectedIndex].ToString() + "/" + txtNam.Text.Trim());
