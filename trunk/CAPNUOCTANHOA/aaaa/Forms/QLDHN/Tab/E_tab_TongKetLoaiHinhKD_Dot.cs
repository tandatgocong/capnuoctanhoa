...
namespace CAPNUOCTANHOA.Forms.QLDHN.Tab
{
    public partial class tab_tab_TongKetLoaiHinhKD : UserControl
    {
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            rp.SetParameterValue("tenbk", "THỐNG KÊ SẢN LƯỢNG TỪNG LOẠI KHÁCH HÀNG ĐỢT " + cbDotDS.Items[cbDotDS.SelectedIndex].ToString() + " KỲ  " + cbKyDS.Items[cbKyDS.SelectedIndex].ToString() + "/" + txtNam.Text.Trim());
