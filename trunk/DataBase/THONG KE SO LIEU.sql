UPDATE HOADONTH01_2013 SET  SONHA= t2.SONHA, DUONG=t2.TENDUONG
FROM TB_DULIEUKHACHHANG t2
WHERE HOADONTH01_2013.DANHBO = t2.DANHBO

UPDATE HOADONTH01_2013 SET  PHUONG= t2.PHUONG, QUAN=t2.QUAN, Khu= t2.LOTRINH
FROM TB_DULIEUKHACHHANG t2
WHERE HOADONTH01_2013.DANHBO = t2.DANHBO

UPDATE HOADONTH12 SET  PHUONG= t2.PHUONG, QUAN=t2.QUAN, Khu= t2.LOTRINH
FROM TB_DULIEUKHACHHANG_HUYDB t2
WHERE HOADONTH12.DANHBO = t2.DANHBO


UPDATE HOADONTH12 SET  NHANVIEN = t2.NAME
