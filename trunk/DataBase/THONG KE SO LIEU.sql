...
UPDATE HOADONTH07_2013 SET  NHANVIEN = t2.NAME
FROM TB_NHANVIENDOCSO t2
WHERE CONVERT(int,SUBSTRING(Khu,3,2))= t2.MAYDS


UPDATE HOADONTH07_2013 SET  SONHA= t2.SONHA, DUONG=t2.TENDUONG
FROM TB_DULIEUKHACHHANG t2
WHERE HOADONTH07_2013.DANHBO = t2.DANHBO
