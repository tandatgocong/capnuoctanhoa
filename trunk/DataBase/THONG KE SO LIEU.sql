...
------------------------------------------------------
UPDATE HOADONTH10_2013 SET  SONHA= t2.SONHA, DUONG=t2.TENDUONG,PHUONG= t2.PHUONG, QUAN=t2.QUAN, Khu= t2.LOTRINH,HIEUDH=t2.HIEUDH,NAMLD = YEAR(t2.NGAYTHAY)
