SELECT COUNT(*) FROM HOADONTH04_2014

ALTER TABLE HOADONTH04_2014
...
UPDATE HOADONTH04_2014 SET  KHU= t2.LOTRINH
FROM TB_DULIEUKHACHHANG t2
WHERE REPLACE(HOADONTH04_2014.DANHBO,' ','') = REPLACE(t2.DANHBO,' ','')



------------------------------------------------------
UPDATE HOADONTH03_2014 SET  SONHA= t2.SONHA, DUONG=t2.TENDUONG,PHUONG= t2.PHUONG, QUAN=t2.QUAN, Khu= t2.LOTRINH,HIEUDH=t2.HIEUDH,NAMLD = YEAR(t2.NGAYTHAY)
FROM TB_DULIEUKHACHHANG t2
WHERE  REPLACE(HOADONTH03_2014.DANHBO,' ','') = REPLACE(t2.DANHBO,' ','')

UPDATE HOADONTH03_2014 SET  SONHA= t2.SONHA, DUONG=t2.TENDUONG,PHUONG= t2.PHUONG, QUAN=t2.QUAN, Khu= t2.LOTRINH,HIEUDH=t2.HIEUDH,NAMLD = YEAR(t2.NGAYTHAY)
FROM TB_DULIEUKHACHHANG_HUYDB t2
WHERE REPLACE(HOADONTH03_2014.DANHBO,' ','') = REPLACE(t2.DANHBO,' ','')

UPDATE HOADONTH04_2014 SET  NHANVIEN = t2.NAME
FROM [CAPNUOCTANHOA].[dbo].[TB_NHANVIENDOCSO] t2
WHERE CONVERT(int,SUBSTRING(Khu,3,2))= t2.MAYDS
------------------------------------------------------

UPDATE HOADONTH11_2013 SET  NHANVIEN = t2.NAME
...
FROM HOADONTH04_2014 kh, PHUONG p, QUAN q
