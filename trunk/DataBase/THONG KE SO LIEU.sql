SELECT COUNT(*) FROM HOADONTH06_2014

ALTER TABLE HOADONTH06_2014
...
------------------------------------------------------
UPDATE HOADONTH06_2014 SET  DANHBO=  REPLACE(HOADONTH06_2014.DANHBO,' ','')

UPDATE HOADONTH06_2014 SET  KHU= t2.LOTRINH
FROM TB_DULIEUKHACHHANG t2
WHERE HOADONTH06_2014.DANHBO= t2.DANHBO
...
UPDATE HOADONTH06_2014 SET  PHUONG= t2.PHUONG, QUAN=t2.QUAN, Khu= t2.LOTRINH,HIEUDH=t2.HIEUDH,NAMLD = YEAR(t2.NGAYTHAY)
FROM TB_DULIEUKHACHHANG t2
WHERE HOADONTH06_2014.DANHBO = t2.DANHBO
...
UPDATE HOADONTH06_2014 SET  NHANVIEN = t2.NAME
...
FROM HOADONTH06_2014 kh, PHUONG p, QUAN q
