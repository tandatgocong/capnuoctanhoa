...
------------------------------------------------------
UPDATE HOADONTH12_2013 SET  SONHA= t2.SONHA, DUONG=t2.TENDUONG,PHUONG= t2.PHUONG, QUAN=t2.QUAN, Khu= t2.LOTRINH,HIEUDH=t2.HIEUDH,NAMLD = YEAR(t2.NGAYTHAY)
FROM TB_DULIEUKHACHHANG t2
WHERE HOADONTH12_2013.DANHBO = t2.DANHBO

UPDATE HOADONTH12_2013 SET  SONHA= t2.SONHA, DUONG=t2.TENDUONG,PHUONG= t2.PHUONG, QUAN=t2.QUAN, Khu= t2.LOTRINH,HIEUDH=t2.HIEUDH,NAMLD = YEAR(t2.NGAYTHAY)
FROM TB_DULIEUKHACHHANG_HUYDB t2
WHERE HOADONTH12_2013.DANHBO = t2.DANHBO

UPDATE HOADONTH12_2013 SET  NHANVIEN = t2.NAME
FROM [CAPNUOCTANHOA_17].[dbo].[TB_NHANVIENDOCSO] t2
