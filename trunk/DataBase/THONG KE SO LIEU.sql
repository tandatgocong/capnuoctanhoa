UPDATE HOADONTH07 SET  PHUONG= t2.PHUONG, QUAN=t2.QUAN, HIEUDHN=t2.HIEUDH,CODHN=t2.CODH,NAMLD=YEAR(t2.NGAYTHAY),Khu= t2.LOTRINH
FROM TB_DULIEUKHACHHANG t2
WHERE HOADONTH07.DANHBO = t2.DANHBO
...
SELECT p.MAQUAN,p.MAPHUONG, p.TENPHUONG, q.TENQUAN, COUNT(*), SUM(lncc)
FROM HOADONTH07 kh, PHUONG p, QUAN q
