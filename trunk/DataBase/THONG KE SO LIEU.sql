...
UPDATE HOADONTH10 SET  PHUONG= t2.PHUONG, QUAN=t2.QUAN, Khu= t2.LOTRINH
FROM TB_DULIEUKHACHHANG t2
WHERE HOADONTH10.DANHBO = t2.DANHBO
...
SELECT Khu,DanhBo,HopDong,TenKH,SoNha,Duong,p.TENPHUONG, q.TENQUAN,kh.GIABIEU,kh.DINHMUC, kh.CODE
FROM HOADONTH10 kh, PHUONG p, QUAN q
WHERE LNCC>0 AND LNCC<=4  AND kh.QUAN = q.MAQUAN AND q.MAQUAN=p.MAQUAN AND kh.PHUONG=p.MAPHUONG 
ORDER BY  p.MAQUAN,p.MAPHUONG ASC
...
AND ds.TIEUTHU=0 AND ds.KY=10 and ds.NAM=2012
