...
SELECT '"' +DANHBO+'","' + LEFT(LOTRINHMOI,2) +'","' + SUBSTRING(LOTRINHMOI,3,2)+'","' + SUBSTRING(LOTRINHMOI,5,5)+'","' + CASE WHEN LECHNGAY>=34 AND DINHMUC<>0 THEN CONVERT(VARCHAR(10),CONVERT(INT,DINHMUC)*2) ELSE ''END+'"'
FROM DMA_TONGLOTRINH 
