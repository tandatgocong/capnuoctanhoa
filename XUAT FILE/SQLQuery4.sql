...
SELECT MADMA, CASE WHEN SUBSTRING(LOTRINH, 3, 2) IN ('01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12', '13', '14', '15') 
                      ...
                      THEN 'TP01' ELSE 'TP02' END END END AS TODS,   SUBSTRING(LOTRINH,1,2) as 'DOT',kh.LOTRINH, kh.DANHBO, kh.HOPDONG, kh.HOTEN, kh.SONHA, kh.TENDUONG,kh.HIEUDH, kh.CODH,SOTHANDH , CODE,CHISOKYTRUOC, VITRIDHN, convert(varchar(20),kh.NGAYTHAY,103) AS NGAYGAN,DIENTHOAI
FROM  TB_DULIEUKHACHHANG kh WHERE YEAR(NGAYTHAY)<=2010
