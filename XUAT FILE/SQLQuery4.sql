...
FROM  TB_DULIEUKHACHHANG kh,  PHUONG p, QUAN q
WHERE kh.QUAN = q.MAQUAN AND q.MAQUAN=p.MAQUAN AND kh.PHUONG=p.MAPHUONG AND kh.QUAN='31' AND kh.PHUONG='01'
...
FROM  TB_DULIEUKHACHHANG kh,HOADONTH07_2014 hd
WHERE kh.DANHBO=hd.DANHBO  and hd.CODE='K'
AND hd.DANHBO IN (SELECT DANHBO FROM HOADONTH06_2014 WHERE CODE='K')
AND hd.DANHBO IN (SELECT DANHBO FROM HOADONTH05_2014 WHERE CODE='K')
ORDER BY  LOTRINH ASC
