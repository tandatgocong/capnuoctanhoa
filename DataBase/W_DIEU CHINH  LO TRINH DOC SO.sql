...
---- TAN BINH 1
SELECT * FROM KHACHHANG WHERE DANHBA='13172426781'
SELECT * FROM DS2015 WHERE DANHBA='13172426781'
SELECT MAX(KY) FROM DS2015 
SELECT * FROM CAPNUOCTANHOA.dbo.TB_DULIEUKHACHHANG  WHERE DANHBO='13172426781'
