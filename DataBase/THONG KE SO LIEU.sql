...
ALTER TABLE HOADONTH06_2013
ADD NHANVIEN nvarchar(250)
go

ALTER TABLE HOADONTH01_2013
ADD MADMA nvarchar(250)
go


UPDATE HOADONTH06_2013 SET  NHANVIEN = t2.NAME
FROM TB_NHANVIENDOCSO t2
WHERE CONVERT(int,SUBSTRING(Khu,3,2))= t2.MAYDS


UPDATE HOADONTH06_2013 SET  SONHA= t2.SONHA, DUONG=t2.TENDUONG
FROM TB_DULIEUKHACHHANG t2
WHERE HOADONTH06_2013.DANHBO = t2.DANHBO
...
WHERE HOADONTH06_2013.DANHBO = t2.DANHBO
------------------------------------------------------
UPDATE HOADONTH06_2013 SET  PHUONG= t2.PHUONG, QUAN=t2.QUAN, Khu= t2.LOTRINH,HIEUDH=t2.HIEUDH,NAMLD = YEAR(t2.NGAYTHAY)
FROM TB_DULIEUKHACHHANG t2
WHERE HOADONTH06_2013.DANHBO = t2.DANHBO
...
UPDATE HOADONTH12_2012 SET  NHANVIEN = t2.NAME
FROM TB_NHANVIENDOCSO t2
WHERE CONVERT(int,SUBSTRING(Khu,3,2))= t2.MAYDS
------------------------------------------------------
