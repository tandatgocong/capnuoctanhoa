SELECT COUNT(*) FROM HOADONTH10_2015

ALTER TABLE HOADONTH10_2015
...
UPDATE HOADONTH10_2015 SET KHU = DOT+''+ CUON+''+MLT;
------------------------------------------------------
UPDATE HOADONTH10_2015 SET  DANHBO=  REPLACE(HOADONTH10_2015.DANHBO,' ','')
 /*
UPDATE TB_DULIEUKHACHHANG SET HOTEN = t2.TENKH,GIABIEU=t2.GIABIEU, DINHMUC=t2.DINHMUC
FROM HOADONTH10_2015 t2
WHERE TB_DULIEUKHACHHANG.DANHBO= t2.DANHBO  and t2.CODE <> 'M'
UPDATE HOADONTH10_2015 SET  KHU= t2.LOTRINH
FROM TB_DULIEUKHACHHANG t2
WHERE REPLACE(HOADONTH10_2015.DANHBO,' ','')=  REPLACE(t2.DANHBO,' ','')

UPDATE HOADONTH10_2015 SET  KHU= t2.LOTRINH
FROM TB_DULIEUKHACHHANG_HUYDB t2
WHERE HOADONTH10_2015.DANHBO= t2.DANHBO
*/

UPDATE HOADONTH10_2015 SET  PHUONG= t2.PHUONG, QUAN=t2.QUAN,HIEUDH=t2.HIEUDH,NAMLD = YEAR(t2.NGAYTHAY)
FROM TB_DULIEUKHACHHANG t2
WHERE HOADONTH10_2015.DANHBO = t2.DANHBO
...
UPDATE HOADONTH10_2015 SET  NHANVIEN = t2.NAME
FROM [CAPNUOCTANHOA].[dbo].[TB_NHANVIENDOCSO] t2
WHERE CONVERT(int,SUBSTRING(Khu,3,2))= t2.MAYDS
------------------------------------------------------
select * from  HOADONTH10_2015 order by khu asc
-------------------------------------------------------
...
UPDATE HOADONTH10_2015 SET  KY01 =CONVERT(varchar(10), t2.LNCC)  +' - Code: ' + t2.Code
FROM HOADONTH01 t2
...
FROM HOADONTH10_2015 kh, PHUONG p, QUAN q
...
SELECT PHUONG,QUAN, COUNT(*) FROM HOADONTH10_2015 GROUP BY PHUONG,QUAN

UPDATE HOADONTH10_2015 SET PHUONG='01' WHERE PHUONG=1
