SELECT COUNT(*) FROM HOADONTH10_2016

ALTER TABLE HOADONTH10_2016
...
UPDATE HOADONTH10_2016 SET KHU = DOT+''+ CUON+''+MLT;
------------------------------------------------------
UPDATE HOADONTH10_2016 SET  DANHBO=  REPLACE(HOADONTH10_2016.DANHBO,' ','')
 /*
UPDATE TB_DULIEUKHACHHANG SET HOTEN = t2.TENKH,GIABIEU=t2.GIABIEU, DINHMUC=t2.DINHMUC
FROM HOADONTH10_2016 t2
WHERE TB_DULIEUKHACHHANG.DANHBO= t2.DANHBO  and t2.CODE <> 'M'
UPDATE HOADONTH10_2016 SET  KHU= t2.LOTRINH
FROM TB_DULIEUKHACHHANG t2
WHERE REPLACE(HOADONTH10_2016.DANHBO,' ','')=  REPLACE(t2.DANHBO,' ','')

UPDATE HOADONTH10_2016 SET  KHU= t2.LOTRINH
FROM TB_DULIEUKHACHHANG_HUYDB t2
WHERE HOADONTH10_2016.DANHBO= t2.DANHBO



UPDATE HOADONTH10_2016 SET  PHUONG= t2.PHUONG, QUAN=t2.QUAN,HIEUDH=t2.HIEUDH,SOTHAN=t2.SOTHANDH,MADMA=t2.MADMA,NGAYGAN = CONVERT(VARCHAR(50),t2.NGAYTHAY,103),
...
UPDATE HOADONTH10_2016 SET  PHUONG= t2.PHUONG, QUAN=t2.QUAN,HIEUDH=t2.HIEUDH,NAMLD = YEAR(t2.NGAYTHAY),SOTHAN=t2.SOTHANDH,MADMA=t2.MADMA
FROM TB_DULIEUKHACHHANG t2
WHERE HOADONTH10_2016.DANHBO = t2.DANHBO

UPDATE HOADONTH10_2016 SET  PHUONG= t2.PHUONG, QUAN=t2.QUAN,HIEUDH=t2.HIEUDH,NAMLD = YEAR(t2.NGAYTHAY)
FROM TB_DULIEUKHACHHANG_HUYDB t2
WHERE HOADONTH10_2016.DANHBO = t2.DANHBO


UPDATE HOADONTH10_2016 SET  NHANVIEN = t2.NAME
FROM TB_NHANVIENDOCSO t2
WHERE CONVERT(int,SUBSTRING(Khu,3,2))= t2.MAYDS

------------------------------------------------------
select * from  HOADONTH10_2016 order by khu asc
-------------------------------------------------------


UPDATE HOADONTH10_2016 SET  KY01 =CONVERT(varchar(10), t2.LNCC)  +' - Code: ' + t2.Code
FROM HOADONTH01 t2
...
FROM HOADONTH10_2016 kh, PHUONG p, QUAN q
...
SELECT PHUONG,QUAN, COUNT(*) FROM HOADONTH10_2016 GROUP BY PHUONG,QUAN

UPDATE HOADONTH10_2016 SET PHUONG='01' WHERE PHUONG=1
