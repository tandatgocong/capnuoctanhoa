SELECT COUNT(*) FROM HOADONTH09_2014

ALTER TABLE HOADONTH09_2014
...
------------------------------------------------------
UPDATE HOADONTH09_2014 SET  DANHBO=  REPLACE(HOADONTH09_2014.DANHBO,' ','')

UPDATE TB_DULIEUKHACHHANG SET HOTEN = t2.TENKH, GIABIEU = t2.GIABIEU, DINHMUC= t2.DINHMUC
FROM HOADONTH09_2014 t2
WHERE TB_DULIEUKHACHHANG.DANHBO= t2.DANHBO  and t2.CODE <> 'M'


 
UPDATE HOADONTH09_2014 SET  KHU= t2.LOTRINH
FROM TB_DULIEUKHACHHANG t2
WHERE HOADONTH09_2014.DANHBO= t2.DANHBO
...
UPDATE HOADONTH09_2014 SET  PHUONG= t2.PHUONG, QUAN=t2.QUAN, Khu= t2.LOTRINH,HIEUDH=t2.HIEUDH,NAMLD = YEAR(t2.NGAYTHAY)
FROM TB_DULIEUKHACHHANG t2
WHERE HOADONTH09_2014.DANHBO = t2.DANHBO
...
UPDATE HOADONTH09_2014 SET  NHANVIEN = t2.NAME
...
FROM HOADONTH09_2014 kh, PHUONG p, QUAN q
