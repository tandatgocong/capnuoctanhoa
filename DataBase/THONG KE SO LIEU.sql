SELECT COUNT(*) FROM HOADONTH03_2014

ALTER TABLE HOADONTH03_2014
...
WHERE HOADONTH03_2014.DANHBO = t2.DANHBO

UPDATE HOADONTH03_2014 SET  SONHA= t2.SONHA, DUONG=t2.TENDUONG,PHUONG= t2.PHUONG, QUAN=t2.QUAN, Khu= t2.LOTRINH,HIEUDH=t2.HIEUDH,NAMLD = YEAR(t2.NGAYTHAY)
FROM TB_DULIEUKHACHHANG_HUYDB t2
WHERE HOADONTH03_2014.DANHBO = t2.DANHBO

UPDATE HOADONTH03_2014 SET  NHANVIEN = t2.NAME
...
FROM HOADONTH03_2014 kh, PHUONG p, QUAN q
