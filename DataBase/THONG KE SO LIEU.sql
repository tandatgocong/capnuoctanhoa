SELECT COUNT(*) FROM HOADONTH10_2014

ALTER TABLE HOADONTH10_2014
...
------------------------------------------------------
UPDATE HOADONTH10_2014 SET  DANHBO=  REPLACE(HOADONTH10_2014.DANHBO,' ','')

UPDATE TB_DULIEUKHACHHANG SET HOTEN = t2.TENKH
FROM HOADONTH10_2014 t2
WHERE TB_DULIEUKHACHHANG.DANHBO= t2.DANHBO  and t2.CODE <> 'M'


 
UPDATE HOADONTH10_2014 SET  KHU= t2.LOTRINH
FROM TB_DULIEUKHACHHANG t2
WHERE REPLACE(HOADONTH10_2014.DANHBO,' ','')= t2.DANHBO

UPDATE HOADONTH10_2014 SET  KHU= t2.LOTRINH
FROM TB_DULIEUKHACHHANG_HUYDB t2
WHERE HOADONTH10_2014.DANHBO= t2.DANHBO


UPDATE HOADONTH10_2014 SET  PHUONG= t2.PHUONG, QUAN=t2.QUAN, Khu= t2.LOTRINH,HIEUDH=t2.HIEUDH,NAMLD = YEAR(t2.NGAYTHAY)
FROM TB_DULIEUKHACHHANG t2
WHERE HOADONTH10_2014.DANHBO = t2.DANHBO
...
UPDATE HOADONTH10_2014 SET  NHANVIEN = t2.NAME
...
UPDATE HOADONTH10_2014 SET  KY01 =CONVERT(varchar(10), t2.LNCC)  +' - Code: ' + t2.Code
FROM HOADONTH01 t2
...
FROM HOADONTH10_2014 kh, PHUONG p, QUAN q
