SELECT COUNT(*) FROM HOADONTH10_2017

ALTER TABLE HOADONTH10_2017
...
UPDATE HOADONTH10_2017 SET KHU = DOT+''+ CUON+''+MLT;
------------------------------------------------------
UPDATE HOADONTH10_2017 SET  DANHBO=  REPLACE(HOADONTH10_2017.DANHBO,' ','')
 /*
UPDATE TB_DULIEUKHACHHANG SET HOTEN = t2.TENKH,GIABIEU=t2.GIABIEU, DINHMUC=t2.DINHMUC
FROM HOADONTH10_2017 t2
WHERE TB_DULIEUKHACHHANG.DANHBO= t2.DANHBO  and t2.CODE <> 'M'
UPDATE HOADONTH10_2017 SET  KHU= t2.LOTRINH
FROM TB_DULIEUKHACHHANG t2
WHERE REPLACE(HOADONTH10_2017.DANHBO,' ','')=  REPLACE(t2.DANHBO,' ','')

UPDATE HOADONTH10_2017 SET  KHU= t2.LOTRINH
FROM TB_DULIEUKHACHHANG_HUYDB t2
WHERE HOADONTH10_2017.DANHBO= t2.DANHBO



UPDATE HOADONTH10_2017 SET  PHUONG= t2.PHUONG, QUAN=t2.QUAN,HIEUDH=t2.HIEUDH,SOTHAN=t2.SOTHANDH,MADMA=t2.MADMA,NGAYGAN = CONVERT(VARCHAR(50),t2.NGAYTHAY,103),
...
UPDATE HOADONTH10_2017 SET  PHUONG= t2.PHUONG, QUAN=t2.QUAN,HIEUDH=t2.HIEUDH,NAMLD = YEAR(t2.NGAYTHAY),SOTHAN=t2.SOTHANDH,MADMA=t2.MADMA
FROM TB_DULIEUKHACHHANG t2
WHERE HOADONTH10_2017.DANHBO = t2.DANHBO

UPDATE HOADONTH10_2017 SET  PHUONG= t2.PHUONG, QUAN=t2.QUAN,HIEUDH=t2.HIEUDH,NAMLD = YEAR(t2.NGAYTHAY)
FROM TB_DULIEUKHACHHANG_HUYDB t2
WHERE HOADONTH10_2017.DANHBO = t2.DANHBO


UPDATE HOADONTH10_2017 SET  NHANVIEN = t2.NAME
FROM TB_NHANVIENDOCSO t2
WHERE CONVERT(int,SUBSTRING(Khu,3,2))= t2.MAYDS

------------------------------------------------------
select * from  HOADONTH10_2017 order by khu asc
-------------------------------------------------------


UPDATE HOADONTH10_2017 SET  KY01 =CONVERT(varchar(10), t2.LNCC)  +' - Code: ' + t2.Code
FROM HOADONTH01 t2
...
FROM HOADONTH10_2017 kh, PHUONG p, QUAN q
...
SELECT PHUONG,QUAN, COUNT(*) FROM HOADONTH10_2017 GROUP BY PHUONG,QUAN

UPDATE HOADONTH10_2017 SET PHUONG='01' WHERE PHUONG=1
...
SELECT  CASE WHEN SUBSTRING(LOTRINH, 3, 2) IN ('01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12', '13', '14', '15') 
                      ...
                      THEN 'TP01' ELSE 'TP02' END END END AS TODS,   SUBSTRING(LOTRINH,1,2) as 'DOT',kh.LOTRINH, kh.DANHBO, kh.HOPDONG, kh.HOTEN, hd.SONHA, hd.DUONG,kh.HIEUDH, kh.CODH,kh.SOTHANDH ,kh.GIABIEU,kh.DINHMUC, kh.VITRIDHN, convert(varchar(20),kh.NGAYTHAY,103) AS NGAYGAN, convert(varchar(20),kh.NGAYKIEMDINH,103) AS KIEMDINH,kh.DIENTHOAI,hd.NHANVIEN
FROM  TB_DULIEUKHACHHANG kh, HOADONTH10_2017 hd  WHERE kh.DANHBO=hd.DANHBO AND   hd.SONHA LIKE '%THUA%'
ORDER BY  LOTRINH ASC
