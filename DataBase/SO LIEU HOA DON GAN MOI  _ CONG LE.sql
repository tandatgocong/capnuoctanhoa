SELECT hd.DOT,hd.KHU,sl.DANHBO,hd.HOPDONG,hd.TENKH,hd.SONHA,hd.DUONG,hd.GIABIEU,hd.DINHMUC,hd.HIEUDH,hd.co,
...
LEFT JOIN HOADONTH02_2015 hd
ON hd.DANHBO=sl.DANHBO
ORDER BY DOT ASC



UPDATE SOLIEUHD2014 SET SOLIEUHD2014.T12015 =hd.LNCC
FROM HOADONTH01_2015 hd
...
INSERT INTO SOLIEUHD2015(DANHBO,T2)
SELECT h.DANHBO, h.LNCC as 'T2'
FROM HOADONTH02_2015 h
WHERE CODE='M';

UPDATE SOLIEUHD2015 SET T2 =hd.LNCC
FROM HOADONTH02_2015 hd
