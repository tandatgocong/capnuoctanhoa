...
sl.T12014,sl.T22014,sl.T32014,sl.T42014,sl.T52014,sl.T62014,SL.T72014,SL.T82014,SL.T92014,SL.T102014
FROM SOLIEUHD2013 sl
LEFT JOIN HOADONTH10_2014 hd
ON hd.DANHBO=sl.DANHBO
ORDER BY DOT ASC



UPDATE SOLIEUHD2013 SET T102014 =hd.LNCC
FROM HOADONTH09_2014 hd
...
FROM HOADONTH10_2014 h
WHERE CODE='M';

UPDATE SOLIEUHD2014 SET T10 =hd.LNCC
FROM HOADONTH10_2014 hd
