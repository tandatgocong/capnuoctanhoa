...
UPDATE TB_THAYDHN SET  TENKH =KH.HOTEN, DIACHI=KH.SONHA + ' ' + KH.TENDUONG,T_LOTRINH=KH.LOTRINH FROM TB_DULIEUKHACHHANG KH
WHERE KH.DANHBO= TB_THAYDHN.DHN_DANHBO AND TENKH IS NULL
