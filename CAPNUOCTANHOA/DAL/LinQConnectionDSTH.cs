...
{
    public static class LinQConnectionDSTH
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(LinQConnectionDSTH).Name);
        ...
        public static int ExecuteCommand(string sql)
        {
            ...
            {
                log.Error("LinQConnectionDSTH ExecuteCommand : " + sql);
                log.Error("LinQConnectionDSTH ExecuteCommand : " + ex.Message);
            }
            finally
            {
                db.Connection.Close();
        ...
        public static DataTable getDataTable(string sql)
        {
            ...
            {
                log.Error("LinQConnectionDSTH getDataTable " + ex.Message);
            }
            finally
            {
                db.Connection.Close();
        ...
        public static void ExecuteStoredProcedure(string storedNam, int ky, int nam)
        {
            ...
            {
                log.Error("LinQConnectionDSTH ExecuteStoredProcedure " + ex.Message);
            }
            finally
            {
                conn.Close();
