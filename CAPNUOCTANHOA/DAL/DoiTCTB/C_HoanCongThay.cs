...
namespace CAPNUOCTANHOA.DAL.DoiTCTB
{
    public static class C_HoanCongThay
    {
        ...
        public static DataTable getBangKeBaoThay(string sobangke)
        {
            ...
            sql += " ,HCT_CAP , HCT_CHISOGO, HCT_SOTHANGO, HCT_HIEUDHNGAN, HCT_CODHNGAN, HCT_SOTHANGAN, HCT_CHISOGAN, HCT_LOAIDHGAN,(case when HCT_TRONGAI='1' then NULL  else HCT_NGAYGAN end ) AS 'HCT_NGAYGAN', HCT_CHITHAN, HCT_CHIGOC, HCT_TRONGAI, HCT_LYDOTRONGAI  ";
