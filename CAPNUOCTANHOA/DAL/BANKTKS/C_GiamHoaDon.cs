...
namespace CAPNUOCTANHOA.DAL.BANKTKS
{
    public static class C_GiamHoaDon
    {
        ...
        public static DataTable getBangKeBySoBangKe(string sobangke)
        {
            ...
            sql += "DHN_CAMKET,DHN_BAMHI,DHN_HUYCAMKET,DHN_GHICHU,DHN_TODS,CONVERT(VARCHAR(10), KTKS_NGAYTIEPXUC, 103) AS KTKS_NGAYTIEPXUC,KTKS_CAMKET,KTKS_BAMHI,KTKS_NGAYBAMCHI,KTKS_MAKIEMBC,KTKS_TH_HIEU,KTKS_TH_CO,KTKS_TH_SOTHAN,KTKS_TH_CHISO,KTKS_TH_MAKIEM,KTKS_TH_NGAY,KTKS_NHANVIEN,KTKS_GHICHU,KTKS_DONGTIEN";
