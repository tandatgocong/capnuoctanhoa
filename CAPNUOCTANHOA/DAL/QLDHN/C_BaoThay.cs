...
namespace CAPNUOCTANHOA.DAL.QLDHN
{
     public static class C_BaoThay
    {
        ...
        {
            string sql = "SELECT ID_BAOTHAY,ID_BAOTHAY,DHN_LOAIBANGKE,DHN_SOBANGKE, DHN_DANHBO,HOTEN, SONHA + ' ' +TENDUONG AS 'DIACHI',DHN_NGAYBAOTHAY,DHN_NGAYGAN,DHN_CHITHAN,DHN_CHIGOC,DHN_HIEUDHN,DHN_CODH,DHN_SOTHAN,DHN_CHISO,DHN_LYDOTHAY ";
            ...
            sql += " FROM TB_THAYDHN thay,TB_DULIEUKHACHHANG kh WHERE kh.DANHBO=thay.DHN_DANHBO AND DHN_SOBANGKE='" + sobangke + "'  AND DHN_TODS='" + DAL.SYS.C_USERS._toDocSo + "' ORDER BY thay.ID_BAOTHAY DESC ";
            return LinQConnection.getDataTable(sql);
