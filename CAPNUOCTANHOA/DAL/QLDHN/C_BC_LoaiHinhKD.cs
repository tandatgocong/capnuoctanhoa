...
namespace CAPNUOCTANHOA.DAL.QLDHN
{
    class C_BC_LoaiHinhKD
    {
        ...
        public static void CAPNHATSOLIEU_BAOCAO_LOAIKD_KYNAY(string nam, int ky)
        {
            ...
            sql += " (";
            sql += " SELECT TODS,";
            sql += " (COUNT(case when GB=11 then 1 else null end)) AS KN_SH_DH, 	(SUM(case when GB=11 then TieuThuMoi else 0 end)) AS KN_SH_SL,";
            sql += " (COUNT(case when GB IN (12,14,34,24) then 1 else null end)) AS KN_SX_DH, 	(SUM(case when GB IN (12,14,34,24) then TieuThuMoi else 0 end)) AS KN_SX_SL,";
            sql += " (COUNT(case when GB IN (15,13,33,23) then 1 else null end)) AS KN_KD_DH, 	(SUM(case when GB IN (15,13,33,23) then TieuThuMoi else 0 end)) AS KN_KD_SL,";
            sql += " (COUNT(case when GB IN (21,51,52) then 1 else null end)) AS KN_CC_DH, 	(SUM(case when GB IN (21,51,52) then TieuThuMoi else 0 end)) AS KN_CC_SL,";
            sql += " (COUNT(case when GB=31 then 1 else null end)) AS KN_HCSN_DH, 	(SUM(case when GB=31 then TieuThuMoi else 0 end)) AS KN_HCSN_SL	";
        ...
        public static void CAPNHATSOLIEU_BAOCAO_LOAIKD_KYTRUOC(string nam, int ky)
        {
            ...
            sql += " (";
            sql += " SELECT TODS,";
            sql += " (COUNT(case when GB=11 then 1 else null end)) AS KT_SH_DH, 	(SUM(case when GB=11 then TieuThuMoi else 0 end)) AS KT_SH_SL,";
            sql += " (COUNT(case when GB IN (12,14,34,24) then 1 else null end)) AS KT_SX_DH, 	(SUM(case when GB IN (12,14,34,24) then TieuThuMoi else 0 end)) AS KT_SX_SL,";
            sql += " (COUNT(case when GB IN (15,13,33,23) then 1 else null end)) AS KT_KD_DH, 	(SUM(case when GB IN (15,13,33,23) then TieuThuMoi else 0 end)) AS KT_KD_SL,";
            sql += " (COUNT(case when GB IN (21,51,52) then 1 else null end)) AS KT_CC_DH, 	(SUM(case when GB IN (21,51,52) then TieuThuMoi else 0 end)) AS KT_CC_SL,";
            sql += " (COUNT(case when GB=31 then 1 else null end)) AS KT_HCSN_DH, 	(SUM(case when GB=31 then TieuThuMoi else 0 end)) AS KT_HCSN_SL	";
            sql += " FROM DocSoTH.dbo.DocSo  t  ";
            sql += " WHERE  KY=" + ky + " AND NAM="+nam ;
            sql += " GROUP BY TODS";
            sql += " ) as t2";
