...
namespace CAPNUOCTANHOA.DAL.QLDHN
{
    class C_BaoCaoCODE
    {
        ...
        public static void CAPNHATSOLIEU_BAOCAO_CODE_KYNAY_DETAIL(string nam, int ky)
        {
            ...
            sql += "   ( ";
            sql += "   SELECT TODS,";
            sql += "   COUNT(case when CodeMoi='60' then 1 else null end) AS KN_60,";
            sql += "   COUNT(case when CodeMoi='61' then 1 else null end) AS KN_61,";
            sql += "   COUNT(case when CodeMoi='62' then 1 else null end) AS KN_62,";
            sql += "   COUNT(case when CodeMoi='63' then 1 else null end) AS KN_63,";
            sql += "   COUNT(case when CodeMoi='64' then 1 else null end) AS KN_64,";
            sql += "   COUNT(case when CodeMoi='65' then 1 else null end) AS KN_65,";
            sql += "   COUNT(case when CodeMoi='66' then 1 else null end) AS KN_66,";
            sql += "   COUNT(case when CodeMoi='67' then 1 else null end) AS KN_67,";
            sql += "   COUNT(case when CodeMoi='68' then 1 else null end) AS KN_68,";
            sql += "   COUNT(case when CodeMoi='54' then 1 else null end) AS KN_54,";
            sql += "   COUNT(case when CodeMoi='58' then 1 else null end) AS KN_58,";
        ...
        public static void CAPNHATSOLIEU_BAOCAO_CODE_KYTRUOC_DETAIL(string nam, int ky)
        {
            ...
            sql += " ( ";
            sql += " SELECT TODS, ";
            sql += " COUNT(case when CodeMoi='60' then 1 else null end) AS KT_60, ";
            sql += " COUNT(case when CodeMoi='61' then 1 else null end) AS KT_61,";
            sql += " COUNT(case when CodeMoi='62' then 1 else null end) AS KT_62,";
            sql += " COUNT(case when CodeMoi='63' then 1 else null end) AS KT_63,";
            sql += " COUNT(case when CodeMoi='64' then 1 else null end) AS KT_64,";
            sql += " COUNT(case when CodeMoi='65' then 1 else null end) AS KT_65,";
            sql += " COUNT(case when CodeMoi='66' then 1 else null end) AS KT_66,";
            sql += " COUNT(case when CodeMoi='67' then 1 else null end) AS KT_67,";
            sql += " COUNT(case when CodeMoi='68' then 1 else null end) AS KT_68,";
            sql += " COUNT(case when CodeMoi='54' then 1 else null end) AS KT_54,";
            sql += " COUNT(case when CodeMoi='58' then 1 else null end) AS KT_58,";
