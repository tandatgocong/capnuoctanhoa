...
namespace CAPNUOCTANHOA.DAL.QLDHN
{
    class C_QuanLyDongHoNuoc
    {
        ...
        public static DataSet getThongKeDHN_HD(int ky, int nam, string tods)
        {
            ...
            LinQConnection.ExecuteStoredProcedure("THONGKEDHN_HD", ky, nam);
        ...
        public static void CAPNHAT_BANGCHAMCONG_HD(string nam, int ky, int tods)
        {
            ...
            sql += " SELECT t.MAY, ";
            sql += " COUNT(case when (t.DOT=1)  then 1 else null end) AS SL01, ";
            sql += " COUNT(case when (t.CODE ='F' AND t.DOT=1)  then 1 else null end) AS DC01, ";
            sql += " COUNT(case when (t.DOT=2)  then 1 else null end) AS SL02, ";
            sql += " COUNT(case when (t.CODE ='F' AND t.DOT=2)  then 1 else null end) AS DC02, ";
            sql += " COUNT(case when (t.DOT=3)  then 1 else null end) AS SL03, ";
            sql += " COUNT(case when (t.CODE ='F' AND t.DOT=3)  then 1 else null end) AS DC03, ";
            sql += " COUNT(case when (t.DOT=4)  then 1 else null end) AS SL04, ";
            sql += " COUNT(case when (t.CODE ='F' AND t.DOT=4)  then 1 else null end) AS DC04, ";
            sql += " COUNT(case when (t.DOT=5)  then 1 else null end) AS SL05, ";
            sql += " COUNT(case when (t.CODE ='F' AND t.DOT=5)  then 1 else null end) AS DC05, ";
            sql += " COUNT(case when (t.DOT=6)  then 1 else null end) AS SL06, ";
            sql += " COUNT(case when (t.CODE ='F' AND t.DOT=6)  then 1 else null end) AS DC06, ";
            sql += " COUNT(case when (t.DOT=7)  then 1 else null end) AS SL07, ";
            sql += " COUNT(case when (t.CODE ='F' AND t.DOT=7)  then 1 else null end) AS DC07, ";
            sql += " COUNT(case when (t.DOT=8)  then 1 else null end) AS SL08, ";
            sql += " COUNT(case when (t.CODE ='F' AND t.DOT=8)  then 1 else null end) AS DC08, ";
            sql += " COUNT(case when (t.DOT=9)  then 1 else null end) AS SL09, ";
            sql += " COUNT(case when (t.CODE ='F' AND t.DOT=9)  then 1 else null end) AS DC09, ";
            sql += " COUNT(case when (t.DOT=10)  then 1 else null end) AS SL10, ";
            sql += " COUNT(case when (t.CODE ='F' AND t.DOT=10)  then 1 else null end) AS DC10, ";
            sql += " COUNT(case when (t.DOT=11)  then 1 else null end) AS SL11, ";
            sql += " COUNT(case when (t.CODE ='F' AND t.DOT=11)  then 1 else null end) AS DC11, ";
            sql += " COUNT(case when (t.DOT=12)  then 1 else null end) AS SL12, ";
            sql += " COUNT(case when (t.CODE ='F' AND t.DOT=12)  then 1 else null end) AS DC12, ";
            sql += " COUNT(case when (t.DOT=13)  then 1 else null end) AS SL13, ";
            sql += " COUNT(case when (t.CODE ='F' AND t.DOT=13)  then 1 else null end) AS DC13, ";
            sql += " COUNT(case when (t.DOT=14)  then 1 else null end) AS SL14, ";
            sql += " COUNT(case when (t.CODE ='F' AND t.DOT=14)  then 1 else null end) AS DC14, ";
            sql += " COUNT(case when (t.DOT=15)  then 1 else null end) AS SL15, ";
            sql += " COUNT(case when (t.CODE ='F' AND t.DOT=15)  then 1 else null end) AS DC15, ";
            sql += " COUNT(case when (t.DOT=16)  then 1 else null end) AS SL16, ";
            sql += " COUNT(case when (t.CODE ='F' AND t.DOT=16)  then 1 else null end) AS DC16, ";
            sql += " COUNT(case when (t.DOT=17)  then 1 else null end) AS SL17, ";
            sql += " COUNT(case when (t.CODE ='F' AND t.DOT=17)  then 1 else null end) AS DC17, ";
            sql += " COUNT(case when (t.DOT=18)  then 1 else null end) AS SL18, ";
            sql += " COUNT(case when (t.CODE ='F' AND t.DOT=18)  then 1 else null end) AS DC18, ";
            sql += " COUNT(case when (t.DOT=19)  then 1 else null end) AS SL19, ";
            sql += " COUNT(case when (t.CODE ='F' AND t.DOT=19)  then 1 else null end) AS DC19, ";
            sql += " COUNT(case when (t.DOT=20)  then 1 else null end) AS SL20, ";
            sql += " COUNT(case when (t.CODE ='F' AND t.DOT=20)  then 1 else null end) AS DC20 ";
            sql += " FROM HOADON_TH  t ";
            sql += " WHERE NAM=" + nam + " AND  KY=" + ky;
            sql += " GROUP BY  t.MAY  ";
            sql += " ) as t2  ";
            sql += " ON TB_BANGCHAMCONG.MAYDS = t2.MAY ";
        ...
        public static DataSet reportChamCongHD(string nam, int ky, int tods)
        {
            CAPNHAT_BANGCHAMCONG_HD(nam, ky, tods);
            DataSet ds = new DataSet();
            if (db.Connection.State == ConnectionState.Open)
            {
                db.Connection.Close();
        ...
        public static void CAPNHAT_BANGCHAMCONG_HD0(string nam, int ky, int tods)
        {
            ...
            try
            {
                ...
                cmd += " DOT05_TC=DOT05-DOT05_DC, DOT06_TC=DOT06-DOT06_DC, DOT07_TC=DOT07-DOT07_DC, DOT08_TC=DOT08-DOT08_DC, ";
        ...
        public static void CAPNHAT_BANGCHAMCONG_HD0_HD(string nam, int ky, int tods)
        {
        ...
        */
        ...
        public static DataSet reportChamCongHD0_HD(string nam, int ky, int tods)
        {
            CAPNHAT_BANGCHAMCONG_HD0_HD(nam, ky, tods);
            DataSet ds = new DataSet();
            if (db.Connection.State == ConnectionState.Open)
            {
                db.Connection.Close();
