...
namespace CAPNUOCTANHOA.Forms.QLDHN.Tab
{
    ...
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(F_tab_TongKetLoaiHinhKD_TieuThuThap).Name);
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            rp.SetParameterValue("tenbk", "THỐNG KÊ TIÊU THỤ THẤP THEO ĐỐI TƯỢNG SỬ DỤNG NƯỚC KỲ " + cbKyDS.Items[cbKyDS.SelectedIndex].ToString() + "/" + txtNam.Text.Trim());
