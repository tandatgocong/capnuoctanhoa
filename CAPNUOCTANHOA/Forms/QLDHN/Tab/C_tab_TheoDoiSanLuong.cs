...
{
    public partial class tab_TheoDoiSanLuong : UserControl
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(tab_TheoDoiSanLuong).Name);
        public tab_TheoDoiSanLuong()
        {
            InitializeComponent();
