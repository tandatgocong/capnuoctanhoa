...
namespace CAPNUOCTANHOA.Forms.QLDHN.Tab
{
    public partial class F_tab_TongKetLoaiHinhKD_TieuThuThap_DOT : UserControl
    {
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            rp.SetParameterValue("tenbk", "THỐNG KÊ TIÊU THỤ THẤP THEO ĐỐI TƯỢNG SỮ DỤNG NƯỚC ĐỢT " + cbKyDS.Items[cbKyDS.SelectedIndex].ToString() + " KỲ " + cbKyDS.Items[cbKyDS.SelectedIndex].ToString() + "/" + txtNam.Text.Trim());
