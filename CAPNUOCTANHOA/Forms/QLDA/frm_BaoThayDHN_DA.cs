...
{
    public partial class frm_BaoThayDHN_DA : UserControl
    {
        AutoCompleteStringCollection namesCollection = new AutoCompleteStringCollection();
        private static readonly ILog log = LogManager.GetLogger(typeof(frm_BaoThayDHN_DA).Name);
        public frm_BaoThayDHN_DA()
        {
            InitializeComponent();
        ...
        private void btIn_Click(object sender, EventArgs e)
        {
            if ("".Equals(this.txtSoBangKe.Text))
            {
                ...
                ReportDocument rp = new rpt_BCBangKe_A4_DA();
