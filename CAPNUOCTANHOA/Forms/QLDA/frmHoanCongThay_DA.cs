...
{
    public partial class frmHoanCongThay_DA : UserControl
    {
        static string mep = ConfigurationManager.AppSettings["mep"].ToString();
        private static readonly ILog log = LogManager.GetLogger(typeof(frmHoanCongThay_DA).Name);
        AutoCompleteStringCollection namesCollection = new AutoCompleteStringCollection();
        AutoCompleteStringCollection namesCollection1 = new AutoCompleteStringCollection();
        public frmHoanCongThay_DA()
        {
            InitializeComponent();
            ...
            //
            txtSoBangKe.Text = "DA-" + DateTime.Now.Year.ToString().Substring(2, 2) + "000";
            ...
            this.txtHieuDHGan.Text = ConfigurationManager.AppSettings["defautHieu"].ToString();
        }
        ...
        public void setData(int i)
        {
            try
            {
                ...
                txtHieuDHGan.Text = !HCT_HIEUDHNGAN.Equals("") ? HCT_HIEUDHNGAN :"ELSTER";
