...
SELECT DANHBO,HOTEN,SONHA,TENDUONG,MADMA ,KY, NAM FROM TB_DULIEUKHACHHANG WHERE MADMA='TH-03-03'
...
UPDATE TB_DULIEUKHACHHANG SET MADMA='TH-03-03' WHERE DANHBO IN (SELECT DANHBO FROM DMA_TEST) AND MADMA IS NULL

 
 UPDATE TB_DULIEUKHACHHANG SET MADMA= NULL  WHERE MADMA='TH-03-03'