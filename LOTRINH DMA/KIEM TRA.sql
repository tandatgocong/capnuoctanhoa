SELECT DANHBO,HOTEN,SONHA,TENDUONG,MADMA FROM TB_DULIEUKHACHHANG WHERE MADMA='TH-09-02'
...
-------------------
UPDATE TB_DULIEUKHACHHANG SET MADMA='TH-03-07' WHERE DANHBO IN (SELECT DANHBO FROM DMA_TEST) AND MADMA IS NULL
...
SELECT * FROM DMA_TEST WHERE MADMA='TH-09-02' AND DANHBO NOT IN (SELECT DANHBO FROM TB_DULIEUKHACHHANG WHERE MADMA='TH-08-02')
