...
SELECT DANHBO,HOTEN,SONHA,TENDUONG,MADMA ,KY, NAM FROM TB_DULIEUKHACHHANG WHERE MADMA='TH-02-03'
...
UPDATE TB_DULIEUKHACHHANG SET MADMA='TH-02-03' WHERE DANHBO IN (SELECT DANHBO FROM DMA_TEST) AND MADMA = ''

 
 UPDATE TB_DULIEUKHACHHANG SET MADMA= ''  WHERE MADMA='TH-02-03'