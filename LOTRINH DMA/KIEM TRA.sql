SELECT DANHBO FROM TB_DULIEUKHACHHANG WHERE MADMA='TH-07-10' AND KY_<=6 AND NAM<=2013
...
SELECT * FROM DMA_TEST WHERE MADMA='TH-08-02' AND DANHBO NOT IN (SELECT DANHBO FROM TB_DULIEUKHACHHANG WHERE MADMA='TH-08-02')
...
UPDATE TB_DULIEUKHACHHANG SET MADMA='TH-07-10' WHERE DANHBO IN (SELECT DANHBO FROM DMA_TEST) AND MADMA IS NULL
