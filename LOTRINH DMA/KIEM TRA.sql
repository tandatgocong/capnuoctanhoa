...
UPDATE TB_DULIEUKHACHHANG SET MADMA= NULL WHERE MADMA='TH-04-02' AND KY_<=6 AND NAM<=2013
...
UPDATE TB_DULIEUKHACHHANG SET MADMA='TH-04-02' WHERE  DANHBO   IN (SELECT DANHBO FROM DMA_TEST WHERE MADMA='TH-04-02')
